...
<@layout.registrationLayout displayInfo=social.displayInfo displayWide=(realm.password && social.providers??); section>
  <div class="card login-card">
    ...
    <div class="login-center">
      <img src="${url.resourcesPath}/img/lamp_for_haiti.png" class="center-logo" />
    </div>
  ...
  <div class="need-help">
    <div class="need-help-item">
      <a href="https://mekomsolutions.slack.com/archives/C08HDCL7PTM" class="support-link" target="_blank">${msg("Support")}</a>
    </div>
    <div class="need-help-item">
      <a href="mailto:support@mekomsolutions.com" class="support-link" target="_blank">${msg("Email")}</a>
    </div>
  </div>
